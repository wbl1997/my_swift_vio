classdef SwiftVioConstants
    % Each line of SwiftVio output csv file except for the header line is an
    ...
    methods
        function obj = SwiftVioConstants(misalignment_dim, extrinsic_global_dim, ...
