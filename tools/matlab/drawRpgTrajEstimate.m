...
ref_dir = ['/uzh_fpv_competition/results/result_submitted_to_uzh_', ...
    'fpv_4_26_2020/result/laptop_MSCKF_nframe_'];
result_dir = ['/uzh_fpv_epipolar5/vio/laptop/', ...
    'MSCKF_n_part_fix/laptop_MSCKF_n_part_fix_'];
