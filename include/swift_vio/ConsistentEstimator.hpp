...
/**
 * @file swift_vio/ConsistentEstimator.hpp
 * @brief Header file for the ConsistentEstimator class. This does all the backend work.
 * @author Jianzhu Huai
 */

#ifndef INCLUDE_SWIFT_VIO_CONSISTENT_ESTIMATOR_HPP_
#define INCLUDE_SWIFT_VIO_CONSISTENT_ESTIMATOR_HPP_
...
#endif /* #ifndef INCLUDE_SWIFT_VIO_CONSISTENT_ESTIMATOR_HPP_ */
