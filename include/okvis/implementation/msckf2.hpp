...
::ceres::ResidualBlockId MSCKF2::addObservation(uint64_t landmarkId,
                                                   uint64_t poseId,
                                                   size_t camIdx,
                                                   size_t keypointIdx) {
...
bool MSCKF2::getGlobalStateEstimateAs(
...
template<class PARAMETER_BLOCK_T>
bool MSCKF2::getSensorStateEstimateAs(
...
template<class PARAMETER_BLOCK_T>
bool MSCKF2::getSensorStateParameterBlockAs(
        uint64_t poseId, int sensorIdx, int sensorType, int stateType,
...
template<class PARAMETER_BLOCK_T>
bool MSCKF2::setGlobalStateEstimateAs(
        uint64_t poseId, int stateType,
...
template<class PARAMETER_BLOCK_T>
bool MSCKF2::getGlobalStateParameterBlockAs(
        uint64_t poseId, int stateType,
        PARAMETER_BLOCK_T & stateParameterBlock) const
{
    // convert base class pointer with various levels of checking
