...
/**
 * @file HybridFrameAbsolutePoseSacProblem.hpp
 * @brief Header file for the HybridFrameAbsolutePoseSacProblem class.
 * @author Stefan Leutenegger
 */

#ifndef INCLUDE_OKVIS_OPENGV_HYBRIDFRAMEABSOLUTEPOSESACPROBLEM_HPP_
#define INCLUDE_OKVIS_OPENGV_HYBRIDFRAMEABSOLUTEPOSESACPROBLEM_HPP_
 ...
 */
class HybridFrameAbsolutePoseSacProblem : public AbsolutePoseSacProblem {
 public:
   ...
   * @warning Only okvis::absolute_pose::HybridFrameNoncentralAbsoluteAdapter supported.
   */
  HybridFrameAbsolutePoseSacProblem(adapter_t & adapter, algorithm_t algorithm)
      : base_t(adapter, algorithm),
        adapterDerived_(
            *static_cast<opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter*>(&_adapter)) {
    OKVIS_ASSERT_TRUE(
        Exception,
        dynamic_cast<opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter*>(&_adapter),
        "only opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter supported");
  }
  ...
  virtual ~HybridFrameAbsolutePoseSacProblem() {
  }
 ...
 protected:
  ...
  opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter & adapterDerived_;
...
#endif /* INCLUDE_OKVIS_OPENGV_HYBRIDFRAMEABSOLUTEPOSESACPROBLEM_HPP_ */
