...
namespace sm { namespace eigen {
    ...
    void assertEqual(const M1 & A, const M2 & B, okvis::source_file_pos const & sfp, std::string const & message = "")
    {
    ...
    void assertNear(const M1 & A, const M2 & B, T tolerance, okvis::source_file_pos const & sfp, std::string const & message = "")
    {
    ...
    template<typename M1, typename M2, typename T>
    void expectNear(const M1 & A, const M2 & B, T tolerance, okvis::source_file_pos const & sfp, std::string const & message = "")
    {
    ...
    void assertFinite(const M1 & A, okvis::source_file_pos const & sfp, std::string const & message = "")
    {
      for(int r = 0; r < A.rows(); r++)
		{
		  for(int c = 0; c < A.cols(); c++)
