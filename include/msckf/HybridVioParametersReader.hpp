/**
 * @file HybridVioParametersReader.hpp
 * @brief Header file for the HybridVioParametersReader class.
 * @author Stefan Leutenegger
 * @author Andreas Forster
 */

#ifndef INCLUDE_OKVIS_HYBRIDVIOPARAMETERSREADER_HPP_
#define INCLUDE_OKVIS_HYBRIDVIOPARAMETERSREADER_HPP_
 ...
 */
class HybridVioParametersReader{
 public:
   ...
   */
  HybridVioParametersReader(const std::string& filename);

  /// @brief Trivial destructor.
  virtual ~HybridVioParametersReader() {}
...
#endif /* INCLUDE_OKVIS_HYBRIDVIOPARAMETERSREADER_HPP_ */
