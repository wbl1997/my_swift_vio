#ifndef INCLUDE_OKVIS_INVARIANT_EKF_HPP_
#define INCLUDE_OKVIS_INVARIANT_EKF_HPP_
...
/*!
 ...
 S: Sensor (IMU)
 */
class InvariantEKF : public HybridFilter {
 ...
 public:
   ...
   */
  InvariantEKF(std::shared_ptr<okvis::ceres::Map> mapPtr);

  virtual ~InvariantEKF();
...
#endif /* INCLUDE_OKVIS_INVARIANT_EKF_HPP_ */
