...
Even following the below instructions, the qtcreator still will create binaries and file structures different from that generated by catkin_make.
...
For the first time, configure the DEFAULT output path as vins_ws/build/msckf2. 
QtCreator may not find cmake files for libraries like roscpp, set the path like /opt/ros/kinetic/share/roscpp/cmake. Doing similar changes for other not found ros libraries.
