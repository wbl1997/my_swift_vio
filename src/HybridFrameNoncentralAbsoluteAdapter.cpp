...
// Constructor.
opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter::HybridFrameNoncentralAbsoluteAdapter(
#ifdef USE_MSCKF2
...
opengv::bearingVector_t opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter::getBearingVector(
    size_t index) const {
...
opengv::point_t opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter::getPoint(
    size_t index) const {
  assert(index < bearingVectors_.size());
...
opengv::translation_t opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter::getCamOffset(
    size_t index) const {
  return camOffsets_[camIndices_[index]];
}

// Retrieve the rotation from a camera of a correspondence to the viewpoint origin.
opengv::rotation_t opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter::getCamRotation(
    size_t index) const {
...
size_t opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter::getNumberCorrespondences() const {
  return points_.size();
}

// Obtain the angular standard deviation in [rad].
double opengv::absolute_pose::HybridFrameNoncentralAbsoluteAdapter::getSigmaAngle(
    size_t index) {
