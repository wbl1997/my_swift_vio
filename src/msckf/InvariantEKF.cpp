...
InvariantEKF::InvariantEKF(std::shared_ptr<okvis::ceres::Map> mapPtr)
    : HybridFilter(mapPtr) {}
...
void InvariantEKF::findRedundantCamStates(
...
int InvariantEKF::marginalizeRedundantFrames(size_t maxClonedStates) {
...
bool InvariantEKF::applyMarginalizationStrategy(
...
bool InvariantEKF::featureJacobianGeneric(
...
msckf::MeasurementJacobianStatus InvariantEKF::measurementJacobianGeneric(
...
bool InvariantEKF::featureJacobian(const MapPoint &mp, Eigen::MatrixXd &H_oi,
...
int InvariantEKF::computeStackedJacobianAndResidual(
...
void InvariantEKF::optimize(size_t /*numIter*/, size_t /*numThreads*/, bool verbose) {
